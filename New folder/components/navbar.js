    ...
    <div id="Navlinks">
        ...
        <div class="dropdown">
            ...
            <div class="drop-content">
                <a href=""><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box2-fill" viewBox="0 0 16 16">
...
<div id="newLi_div">
   <ul id="rest_nav">
        ...
        <li>Support</li>
        <li>Trips</li>
        <li><a href="../Login/SignUp/Signin.html">Sign In</a></li>
   </ul> 
</div>`
}
